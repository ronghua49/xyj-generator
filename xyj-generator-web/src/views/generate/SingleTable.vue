        ...
        <el-form ref="optionForm" class="optionForm" :inline="true" label-width="70px"
          ...
          <span>
            <el-form-item label="包名">
              <el-input v-model="generateModel.basePackage" placeholder="如：com.xyjsoft.demo">
...
<script>
  ...
  export function downloadCode(baseUrl,params) {
    return axios({
      headers: {
  ...
  export default {
    ...
    methods: {
      ...
      tableSelectionChange(selections) {
        ...
        axios.post(this.baseUrl + "/getGenerateModel", params).then(res => {
          ...
          if (res.code == 200) {
            ...
            this.generateModel.outPutFolderPath = 'C:\\xyjsoft'
      ...
      // 选择代码输出目录
      chooseBasePackage() {
        this.generateModel.basePackage = 'com.xyjsoft.demo'
      },
      // 选择代码输出目录
      chooseOutputFolder() {
        this.generateModel.outPutFolderPath = 'C:\\xyjsoft'
      ...
      // 代码下载
      download() {
       const params = { "path":this.generateModel.outPutFolderPath};
       downloadCode(this.baseUrl,params).then(res => {
          console.log(res.data)
          const blob = new Blob([res.data]);//处理文档流
          const fileName = 'generatorCode.zip';
